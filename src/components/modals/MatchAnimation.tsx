  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <h1 className="text-5xl font-bold text-white mb-8" style={{ fontFamily: 'Lobster, cursive' }}>It's a Match!</h1>
          ...
          <div className="relative flex justify-center items-center h-48">
            ...
            <motion.div 
              initial={{ x: 100, rotate: 15, scale: 0.8 }}
              animate={{ x: 40, rotate: 8, scale: 1 }}
              className="absolute w-40 h-40 rounded-full border-4 border-pink-500 shadow-lg overflow-hidden"
            >
          ...
          <motion.button
            ...
            className="mt-16 px-8 py-3 bg-pink-600 text-white font-bold rounded-full shadow-lg transition-all duration-300 hover:bg-pink-700"
          >
            Send a Message
          </motion.button>
